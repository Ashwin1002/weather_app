...
class _IndexScreenState extends State<IndexScreen> {
    ...
    timer = Timer(
      ...
      () {
        Provider.of<IndexState>(context, listen: false)
            .init(latitude: "27.72", longitude: "85.32");
      },
    );
  }
  ...
  getDateFormat({required String dateData}) async {
    DateTime convDate = await DateTime.parse(dateData);
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<IndexState>(builder: (context, state, child) {
      ...
      // final newTime = getAMOrPM(hour: state.locationDataModel.localtime);
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(
                                        color:
                                            Colors.yellow.shade600.withOpacity(0))),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RowItem(
                            ...
                            rowData:
                                "${state.weatherDataModel.windDir.toString()} Kmph",
                          ),
                          RowItem(
                            rowTitle: 'Humidity',
